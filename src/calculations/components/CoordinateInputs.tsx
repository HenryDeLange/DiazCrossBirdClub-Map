    ...
    return (
        <div className={`${styles.fieldSection} ${styles.locationBlock}`}>
            ...
            <div className={`${styles.coordinateControls} ${locationView ? styles.coordinateControlsReadonly : ''}`}>
                <label>
                    <span className={styles.coordinateInputWrap}>
                        <span className={styles.hemisphereIndicator} aria-hidden='true'>{getHemisphere(latitudeInput, 'latitude')}</span>
                ...
                <label>
                    <span className={styles.coordinateInputWrap}>
                        <span className={styles.hemisphereIndicator} aria-hidden='true'>{getHemisphere(longitudeInput, 'longitude')}</span>
...
function getHemisphere(value: string, kind: keyof Coordinates): 'N' | 'S' | 'E' | 'W' {
